      ...
      <div className="section-container">
        <div className="about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '50px', alignItems: 'center' }}>
          ...
          <div className="about-content">
            ...
            <div className="about-cards-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '30px' }}>
              <div className="about-card" style={{ background: '#0F172A', padding: '18px', borderRadius: '14px', borderLeft: '4px solid #FF6B00', borderTop: '1px solid var(--border-light)', borderRight: '1px solid var(--border-light)', borderBottom: '1px solid var(--border-light)' }}>
              ...
              <div className="about-card" style={{ background: '#0F172A', padding: '18px', borderRadius: '14px', borderLeft: '4px solid #00B4D8', borderTop: '1px solid var(--border-light)', borderRight: '1px solid var(--border-light)', borderBottom: '1px solid var(--border-light)' }}>
                <div style={{ fontWeight: 700, fontSize: '1rem', color: '#FFFFFF', marginBottom: '4px', display: 'flex', alignItems: 'center', gap: '6px' }}>
