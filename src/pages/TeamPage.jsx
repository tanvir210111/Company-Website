      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ color: '#94A3B8', fontSize: '1.1rem', maxWidth: '850px', lineHeight: 1.6 }}>
            Our passionate team of experienced software engineers, senior design mentors, digital growth strategists, and academic coordinators.
          </p>
        </div>

        {/* Filter Tabs */}
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '40px' }}>
          {["All", "Leadership", "Software", "Graphics", "Marketing", "Support"].map(cat => (
            <button
              key={cat}
