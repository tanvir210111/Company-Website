          ...
          {webServices.map(service => (
            <div key={service.id} style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                <div style={{ position: 'relative', height: '180px', overflow: 'hidden', borderBottom: '2px solid #00B4D8' }}>
                  ...
                  <span style={{ position: 'absolute', top: '16px', right: '16px', background: 'rgba(7, 10, 18, 0.85)', backdropFilter: 'blur(8px)', color: '#00B4D8', fontSize: '0.76rem', fontWeight: 700, padding: '4px 12px', borderRadius: '20px', border: '1px solid var(--border-light)' }}>
                    {service.category}
                  </span>
                </div>
              ...
              <div style={{ padding: '16px 28px 24px 28px', borderTop: '1px solid var(--border-light)', marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  <div style={{ fontSize: '1.2rem', fontWeight: 800, color: '#00B4D8' }}>{service.startingPrice}</div>
                </div>
